...
#ifndef AVE_BASE_FUNCTION_VIEW_H_
#define AVE_BASE_FUNCTION_VIEW_H_
...
// Example use:
//
//   void SomeFunction(ave::base::FunctionView<int(int)> index_transform);
//   ...
...
#endif  // AVE_BASE_FUNCTION_VIEW_H_
