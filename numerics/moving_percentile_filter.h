/*
 * moving_percentile_filter.h - Moving percentile filter
 *
...
#ifndef BASE_NUMERICS_MOVING_PERCENTILE_FILTER_H_
#define BASE_NUMERICS_MOVING_PERCENTILE_FILTER_H_
...
#endif  // BASE_NUMERICS_MOVING_PERCENTILE_FILTER_H_
