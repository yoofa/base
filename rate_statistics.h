/*
 * rate_statistics.h - Rate statistics based on counts in time intervals
 * Ported from WebRTC (rtc_base/rate_statistics.h)
 *
...
#ifndef BASE_RATE_STATISTICS_H_
#define BASE_RATE_STATISTICS_H_
