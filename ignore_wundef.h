...
#ifndef AVE_BASE_IGNORE_WUNDEF_H_
#define AVE_BASE_IGNORE_WUNDEF_H_
...
#ifdef __clang__
#define AVE_PUSH_IGNORING_WUNDEF() \
  _Pragma("clang diagnostic push") \
      _Pragma("clang diagnostic ignored \"-Wundef\"")
#define AVE_POP_IGNORING_WUNDEF() _Pragma("clang diagnostic pop")
#else
#define AVE_PUSH_IGNORING_WUNDEF()
#define AVE_POP_IGNORING_WUNDEF()
#endif  // __clang__

#endif  // AVE_BASE_IGNORE_WUNDEF_H_
