...
#ifndef AVE_BASE_BYTE_BUFFER_H_
#define AVE_BASE_BYTE_BUFFER_H_
...
class ByteBufferWriterT {
 ...
 public:
  ...
  void WriteUInt24(uint32_t val) {
    ...
    auto* start = reinterpret_cast<value_type*>(&v);
    ++start;
  ...
  void WriteUVarint(uint64_t val) {
    ...
    auto last_byte = static_cast<value_type>(val);
...
class ByteBufferReader {
 public:
  ...
  bool ReadStringView(std::string_view* val, size_t len);
