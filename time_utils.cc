 ...
 public:
  ...
  static void SyncWithNtp(int64_t ntp_server_time_ms) {
    ...
    int64_t time_zone_bias_ns =
        static_cast<int64_t>(time_zone.Bias) * 60 * 1000 * 1000 * 1000;
  ...
  static int64_t TicksNs() {
    ...
    result = static_cast<int64_t>(
        (static_cast<uint64_t>(qpcnt.QuadPart) * 100000 /
         static_cast<uint64_t>(singleton.os_ticks_per_second_)) *
        10000);
 ...
 private:
  ...
  void UpdateReferenceTime() {
    ...
    time_since_os_start_ns_ =
        static_cast<int64_t>((static_cast<uint64_t>(qpcnt.QuadPart) * 100000 /
